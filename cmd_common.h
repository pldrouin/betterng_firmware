...
#define ADD_LM75A_TEMP_SENSOR_CMD_REQ_ID (204) // 2 bytes
#define DEL_LM75A_TEMP_SENSOR_CMD_REQ_ID (205) // 2 bytes
#define GET_LM75A_TEMP_SENSOR_LIST_CMD_REQ_ID (206) // 1 bytes
#define ADD_ANALOG_TEMP_SENSOR_CMD_REQ_ID (207) // 2 bytes
#define DEL_ANALOG_TEMP_SENSOR_CMD_REQ_ID (208) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_LIST_CMD_REQ_ID (209) // 1 bytes
#define GET_LM75A_TEMP_SENSOR_VALUE_CMD_REQ_ID (210) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_VALUE_CMD_REQ_ID (211) // 2 bytes
#define GET_SOFT_TEMP_SENSOR_VALUE_CMD_REQ_ID (212) // 2 bytes
#define GET_LM75A_TEMP_SENSOR_CALIB_CMD_REQ_ID (213) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_CALIB_CMD_REQ_ID (214) // 2 bytes
#define SET_LM75A_TEMP_SENSOR_CALIB_CMD_REQ_ID (215) // 8 bytes
#define SET_ANALOG_TEMP_SENSOR_CALIB_CMD_REQ_ID (216) // 8 bytes
#define SET_SOFT_TEMP_SENSOR_VALUE_CMD_REQ_ID (217) // 4 bytes
#define GET_LM75A_TEMP_SENSOR_ALARM_VALUE_CMD_REQ_ID (218) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_ALARM_VALUE_CMD_REQ_ID (219) // 2 bytes
#define GET_SOFT_TEMP_SENSOR_ALARM_VALUE_CMD_REQ_ID (220) // 2 bytes
#define SET_LM75A_TEMP_SENSOR_ALARM_VALUE_CMD_REQ_ID (221) // 4 bytes
#define SET_ANALOG_TEMP_SENSOR_ALARM_VALUE_CMD_REQ_ID (222) // 4 bytes
#define SET_SOFT_TEMP_SENSOR_ALARM_VALUE_CMD_REQ_ID (223) // 4 bytes
...
#define GET_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID (206) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID (209) // 2 bytes
#define GET_LM75A_TEMP_SENSOR_VALUE_CMD_RESP_ID (210) // 3 bytes
#define GET_ANALOG_TEMP_SENSOR_VALUE_CMD_RESP_ID (211) // 3 bytes
#define GET_SOFT_TEMP_SENSOR_VALUE_CMD_RESP_ID (212) // 3 bytes
#define GET_LM75A_TEMP_SENSOR_CALIB_CMD_RESP_ID (213) // 8 bytes
#define GET_ANALOG_TEMP_SENSOR_CALIB_CMD_RESP_ID (214) // 8 bytes
#define GET_LM75A_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID (218) // 3 bytes
#define GET_ANALOG_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID (219) // 3 bytes
#define GET_SOFT_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID (220) // 3 bytes
