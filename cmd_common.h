...
#define ADD_LM75A_TEMP_SENSOR_CMD_REQ_ID (198) // 2 bytes
#define DEL_LM75A_TEMP_SENSOR_CMD_REQ_ID (199) // 2 bytes
#define GET_LM75A_TEMP_SENSOR_LIST_CMD_REQ_ID (200) // 1 bytes
#define ADD_ANALOG_TEMP_SENSOR_CMD_REQ_ID (201) // 2 bytes
#define DEL_ANALOG_TEMP_SENSOR_CMD_REQ_ID (202) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_LIST_CMD_REQ_ID (203) // 1 bytes
...
#define GET_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID (200) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID (203) // 2 bytes
