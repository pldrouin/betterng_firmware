...
#define ADD_LM75A_TEMP_SENSOR_CMD_REQ_ID (197) // 2 bytes
#define DEL_LM75A_TEMP_SENSOR_CMD_REQ_ID (198) // 2 bytes
#define GET_LM75A_TEMP_SENSOR_LIST_CMD_REQ_ID (199) // 1 bytes
#define ADD_ANALOG_TEMP_SENSOR_CMD_REQ_ID (200) // 2 bytes
#define DEL_ANALOG_TEMP_SENSOR_CMD_REQ_ID (201) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_LIST_CMD_REQ_ID (202) // 1 bytes
#define GET_ANALOG_TEMP_SENSOR_ADC_VALUE_CMD_REQ_ID (203) // 2 bytes
#define GET_LM75A_TEMP_SENSOR_VALUE_CMD_REQ_ID (204) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_VALUE_CMD_REQ_ID (205) // 2 bytes
#define GET_SOFT_TEMP_SENSOR_VALUE_CMD_REQ_ID (206) // 2 bytes
#define GET_LM75A_TEMP_SENSOR_CALIB_CMD_REQ_ID (207) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_CALIB0_CMD_REQ_ID (208) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_CALIB1_CMD_REQ_ID (209) // 2 bytes
#define SET_LM75A_TEMP_SENSOR_CALIB_CMD_REQ_ID (210) // 8 bytes
#define SET_ANALOG_TEMP_SENSOR_CALIB0_CMD_REQ_ID (211) // 10 bytes
#define SET_ANALOG_TEMP_SENSOR_CALIB1_CMD_REQ_ID (212) // 8 bytes
...
#define GET_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID (199) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID (202) // 2 bytes
#define GET_ANALOG_TEMP_SENSOR_ADC_VALUE_CMD_RESP_ID (203) // 3 bytes
#define GET_LM75A_TEMP_SENSOR_VALUE_CMD_RESP_ID (204) // 3 bytes
#define GET_ANALOG_TEMP_SENSOR_VALUE_CMD_RESP_ID (205) // 3 bytes
#define GET_SOFT_TEMP_SENSOR_VALUE_CMD_RESP_ID (206) // 3 bytes
#define GET_LM75A_TEMP_SENSOR_CALIB_CMD_RESP_ID (207) // 8 bytes
#define GET_ANALOG_TEMP_SENSOR_CALIB0_CMD_RESP_ID (208) // 10 bytes
#define GET_ANALOG_TEMP_SENSOR_CALIB1_CMD_RESP_ID (209) // 8 bytes
