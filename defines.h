...
#define IDLE_TIMER_WAVEFORM_MODE_BIT_1		WGM11	
#define IDLE_TIMER_WAVEFORM_MODE_BIT_0		WGM10	

#define IDLE_TIMER_REG				TCNT1	
#define IDLE_OUTPUT_COMPARE_REG			OCR1A	

#define IDLE_TIMER_INTR_MASK_REG		TIMSK	
#define IDLE_TIMER_ENABLE_COMPARE_MATCH_INTR	OCIE1A	
