...
#define FAN_DVDOUT_DEFAULT_VALUE ((uint16_t)((FAN_MAX_VOLTAGE_SCALE-FAN_SAFE_WORKING_VOLTAGE)/(FAN_DVDOUT_SCALE*UINT8_MAX)))
#define FAN_D2VDOUT2_DEFAULT_VALUE ((int16_t)(0/(FAN_D2VDOUT2_SCALE*UINT8_MAX*UINT8_MAX)))
